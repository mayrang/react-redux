...
(function (global, factory) {
  ...
  function printWarning(level, format, args) {
    ...
    // update consoleWithStackDev.www.js as well.
    {
      var hasExistingStack =
        args.length > 0 && typeof args[args.length - 1] === "string" && args[args.length - 1].indexOf("\n    in") === 0;
  ...
  function stopFailedWorkTimer(fiber) {
    {
      ...
      fiber._debugIsCurrentlyTiming = false;
      var warning =
        fiber.tag === SuspenseComponent ? "Rendering was suspended" : "An error was thrown inside this error boundary";
  ...
  function shouldRemainOnFallback(suspenseContext, current, workInProgress) {
    ...
    return (
      hasSuspenseContext(suspenseContext, ForceSuspenseFallback) && (current === null || current.memoizedState !== null)
    );
  }
